    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("getListeClient".equals(sma)) {
                ...
                if (denominationParametre == null || villeParametre == null) {
                    throw new ServiceException("Paramètres incomplets");
                }
                
                service.rechercherClientParDenomination(denominationParametre, villeParametre);

            } else if ("rechercherClientParNomPersonne".equals(sma)) {
                String nomPersonneParametre = request.getParameter("nomPersonne");
                String villeParametre = request.getParameter("ville");
                
                if (nomPersonneParametre == null || villeParametre == null) {
                    throw new ServiceException("Paramètres incomplets");
                }                
                
                service.rechercherClientParNomPersonne(nomPersonneParametre, villeParametre);

    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("getListeClient".equals(som)) {
                ...
                String personneIdsParametre = request.getParameter("personneIds");
                String villeParametre = request.getParameter("ville");
                
                if(personneIdsParametre == null || villeParametre == null) {
                    throw new ServiceException("Paramètres incomplets");
                }
                
                service.rechercherClientParPersonne(personneIdsParametre, villeParametre);
